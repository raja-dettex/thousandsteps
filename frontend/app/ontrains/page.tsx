        ...
        {ontrainTrips.map((trip, idx) => (
          ...
          >
            ...
            <div className="p-6 flex flex-col justify-between w-full">
              ...
              <button onClick={e=> router.push('/trips/booking/puri')}className="mt-6 bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition w-full md:w-auto self-start">
                Book Now
              </button>
            </div>
          </div>
